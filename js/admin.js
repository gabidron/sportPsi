...
const goToNewResPage = () => {
     window.location.href = "http://127.0.0.1:5500/new-res.html"
}
const goToNewPostPage = () => {
     window.location.href = "http://127.0.0.1:5500/new-post.html";
}
const goToNewWebPage = () => {
     window.location.href = "http://127.0.0.1:5500/new-web.html";
}
const goToPost = (id) => {
     window.location.href = "http://127.0.0.1:5500/post.html?id=" + id;
}
const editPost = (id) => {
